...
const App = () => {
  const { color, colorsList, handleSubmitSaveColor, handleChangeColor, handleClickClearColors } = useColors();
      ...
      <div className="container-sm mt-4">
        <div className="row">
          <div className="col-12 col-md-4">
            <ColorList colorsList={colorsList} handleClickClearColors={handleClickClearColors} />
          </div>
